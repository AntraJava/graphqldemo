package com.antra.user.graphqldemo.config;

import com.antra.user.graphqldemo.graph.GraphQLDataFetchers;
    ...
    private RuntimeWiring buildWiring() {
        return RuntimeWiring.newRuntimeWiring()
                ...
                .type(newTypeWiring("Mutation")
                        .dataFetcher("createAuthor", graphQLDataFetchers.createAuthor()))
                .build();
    }
}
